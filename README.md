...
![Power Law](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/power-law/power_law.png)
...
![Rainbow Chart](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/rainbow/rainbow_chart.png)

#### Power Law Oscillator
Measures deviation from the power law trend line, oscillating between oversold and overbought zones.

![Power Law Oscillator](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/power-law-oscillator/power_law_oscillator.png)
...
![Pi Cycle Top](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/pi-cycle-top/pi_cycle_top.png)
...
![Pi Cycle Top Estimate](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/pi-cycle-top-estimate/pi_cycle_top_estimate.png)
...
![Model Price Prediction](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/model_price_prediction/model_price_prediction.png)

#### Cycle Phase Dashboard
Compact cycle snapshot combining trend, drawdown, halving progress, Puell, fees, and volatility gauges.

![Cycle Phase Dashboard](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/cycle_phase_dashboard/cycle_phase_dashboard.png)

#### Regime Mosaic
Monthly state map showing how Bitcoin moves across trend, Mayer, Puell, drawdown, and volatility regimes over time.

![Regime Mosaic](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/regime_mosaic/regime_mosaic.png)
...
![Price Acceptance Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/price_acceptance_heatmap/price_acceptance_heatmap.png)
...
![Price Prediction](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/price_prediction/price_prediction.png)
...
![Halving Cycles](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/halving_cycles/halving_cycles.png)
...
![Halving Phase Compass](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/halving_phase_compass/halving_phase_compass.png)
...
![Halving Era ROI Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/halving_era_roi_heatmap/halving_era_roi_heatmap.png)

#### Epoch Candles
Price history divided into halving epochs with multipliers showing the price increase during each period.

![Epoch Candles](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/epoch_candles/epoch_candles.png)
...
![EOE Growth](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/eoe_growth/eoe_growth.png)
...
![200 DMA 200 WMA](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/200_dma_200_wma/200_dma_200_wma.png)

#### Mayer Multiple
BTC price divided by the 200-day moving average, with classic cycle zones for below-trend and overheated regimes.

![Mayer Multiple](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/mayer_multiple/mayer_multiple.png)
...
![Bollinger Bands](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/bollinger-bands/bollinger_bands.png)

#### Volatility Regimes
Rolling realized volatility with percentile bands to distinguish low, high, and extreme volatility regimes.

![Volatility Regimes](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/volatility_regimes/volatility_regimes.png)
...
![Intraday Volatility Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/intraday_volatility_heatmap/intraday_volatility_heatmap.png)
...
![Distance From 200DMA Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/distance_from_200dma_heatmap/distance_from_200dma_heatmap.png)
...
![Monthly Yearly Returns](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/monthly_yearly_returns/monthly_yearly_returns.png)

#### Quarterly & Yearly Returns
Same concept as above but broken down by quarters instead of months.

![Quarterly Yearly Returns](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/quarterly_yearly_returns/quarterly_yearly_returns.png)

#### CAGR (Compound Annual Growth Rate)
Dual-panel chart showing Bitcoin price with CAGR lines overlaid, and CAGR evolution over network age.

![CAGR](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/cagr/cagr.png)
...
![Risk Adjusted Returns](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/risk_adjusted_returns/risk_adjusted_returns.png)
...
![Return Volatility Map](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/return_volatility_map/return_volatility_map.png)

#### Seasonality Heatmap
Return seasonality maps for the 24/7 trading week and the calendar year, using intraday mean returns and daily hit rates.

![Seasonality Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/seasonality_heatmap/seasonality_heatmap.png)
...
![Monthly Candles](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/monthly_candles/monthly_candles.png)

#### Yearly Candlesticks
Aggregates daily data into yearly OHLC candles on a log scale.

![Yearly Candles](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/yearly_candles/yearly_candles.png)

#### Yearly Windows
2x2 grid showing 1Y, 2Y, 3Y, and 4Y price windows with open/high/low/close and percentage changes.

![Yearly Windows](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/yearly_windows/yearly_windows.png)

#### Cycle High Drawdown
Compares drawdown percentages from cycle highs across multiple historical cycles, overlaid for pattern comparison.

![Cycle High Drawdown](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/cycle_high_drawdown/cycle_high_drawdown.png)

#### Drawdown Recovery Map
Maps ATH drawdowns against recovery duration, highlighting the deepest historical underwater periods.

![Drawdown Recovery Map](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/drawdown_recovery_map/drawdown_recovery_map.png)

#### Drawdown Duration Heatmap
Shows how long each major peak-to-recovery drawdown spent in different underwater depth buckets.

![Drawdown Duration Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/drawdown_duration_heatmap/drawdown_duration_heatmap.png)

#### Days Since ATH
Dashboard with BTCUSD price chart and days-since-ATH counter, showing halving events and cycle peaks.

![Days Since ATH](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/days_since_ath/days_since_ath.png)

#### Days at a Loss
Shows how many days purchases at each price point have spent underwater, with a gradient heatmap.

![Days at a Loss](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/days_at_a_loss/days_at_a_loss.png)

#### Never Look Back Price
Tracks the highest price Bitcoin reached and never fell below again.

![Never Look Back Price](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/never_look_back_price/never_look_back_price.png)
...
![HODL Waves](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/hodl_waves_price/hodl_waves_price.png)

#### Puell Multiple
Miner revenue in USD divided by its 365-day moving average, with historical accumulation and overheated zones.

![Puell Multiple](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/puell_multiple/puell_multiple.png)

#### Fee Pressure
Fees, fee share of miner revenue, and block-space fee rate using repo-local block CSV data.

![Fee Pressure](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/fee_pressure/fee_pressure.png)
...
![Fee Pressure Heatmap](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/fee_pressure_heatmap/fee_pressure_heatmap.png)

#### Miner Hashprice
Miner revenue per PH/s/day using difficulty-implied network hashrate and repo-local miner revenue.

![Miner Hashprice](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/miner_hashprice/miner_hashprice.png)

#### Node Count
Visualizes Bitcoin network node counts and software version distribution over time.

![Node Count](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/node_count/node_count.png)

#### Price Distribution
Historical price trend with halving events and distribution of daily closing prices across price ranges.

![Price Distribution](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/price_distribution/price_distribution.png)

#### DCA Cost Basis
Weighted average cost basis for daily Dollar-Cost Averaging over different durations vs. spot price.

![DCA Cost Basis](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/dca_cost_basis/dca_cost_basis.png)

#### Unit of Account (BTC/USD)
Dual chart: price of 1 USD in satoshis (left) and price of 1 BTC in USD (right).

![UOA BTC USD](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/uoa_btc_usd/uoa_btc_usd.png)
...
| | | |
|:---:|:---:|:---:|
| ![AAPL](https://jamestsetsekas.github.io/Fintech-clean/Stock/IndividualStockAnalysis/AAPL_stock_analysis.png) | ![NVDA](https://jamestsetsekas.github.io/Fintech-clean/Stock/IndividualStockAnalysis/NVDA_stock_analysis.png) | ![MSTR](https://jamestsetsekas.github.io/Fintech-clean/Stock/IndividualStockAnalysis/MSTR_stock_analysis.png) |
...
|:---:|:---:|
| ![Default](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockPerformanceComparison/stock_performance_comparison_default.png) | ![SP500](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockPerformanceComparison/stock_performance_comparison_sp500_top10.png) |
...
|:---:|:---:|
| ![Default](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockCorrelation/correlation_clusters_default.png) | ![NASDAQ](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockCorrelation/correlation_clusters_nasdaq_top15.png) |
...
| AAPL | NVDA | MSFT |
|:---:|:---:|:---:|
| ![AAPL](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockTechnicalIndicators/AAPL_technical_indicators.png) | ![NVDA](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockTechnicalIndicators/NVDA_technical_indicators.png) | ![MSFT](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockTechnicalIndicators/MSFT_technical_indicators.png) |
...
| Default | S&P 500 Top 10 |
|:---:|:---:|
| ![Default](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockVolatilityAnalysis/stock_volatility_analysis_default.png) | ![SP500](https://jamestsetsekas.github.io/Fintech-clean/Stock/StockVolatilityAnalysis/stock_volatility_analysis_sp500_top10.png) |
...
See [Bitcoin/data/UPDATE_INSTRUCTIONS.md](https://jamestsetsekas.github.io/Fintech-clean/Bitcoin/data/UPDATE_INSTRUCTIONS.md) for keeping price and blockchain data current.
